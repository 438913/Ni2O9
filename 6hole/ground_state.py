...
#     wgt_d9L4d10= np.zeros(10)  
    ...
    wgt_d7d7= np.zeros(80)     
    wgt_d7d8L= np.zeros(80)     
    wgt_d7d8O= np.zeros(80)   
    wgt_d7d9= np.zeros(80) 
    wgt_d7d10= np.zeros(80)    
#     wgt_s= np.zeros(10)         
#     wgt_ds= np.zeros(30)           
#     wgt_dds= np.zeros(80)    
...
#                ", weight = ", weight,'\n')                     
            ...
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 in pam.Ni_Cu_orbs) and (orb6 in pam.Ni_Cu_orbs) and z1==z2==z3==2 and z4==z5==z6==0 : 
                wgt_d7d7[0]+=abs(vecs[istate,k])**2        
                if orb1=='d3z2r2' and orb2=='dx2y2' and orb3=='dx2y2' and orb4=='d3z2r2' and orb5=='dx2y2' and orb6=='dx2y2':
                    wgt_d7d7[1]+=abs(vecs[istate,k])**2   
                if orb1=='d3z2r2' and orb2=='d3z2r2' and orb3=='dx2y2' and orb4=='d3z2r2' and orb5=='d3z2r2' and orb6=='dx2y2':
                    wgt_d7d7[2]+=abs(vecs[istate,k])**2                           
                if orb1=='dx2y2' and orb2=='dx2y2' and orb3=='dx2y2' and orb4=='dx2y2' and orb5=='dx2y2' and orb6=='dx2y2':
                    wgt_d7d7[3]+=abs(vecs[istate,k])**2                        
                    
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 in pam.Ni_Cu_orbs) and (orb6 in pam.O_orbs) and z1==z2==z3==2 and z4==z5==z6==0 : 
                wgt_d7d8L[0]+=abs(vecs[istate,k])**2      
                if orb1=='d3z2r2' and orb2=='dx2y2' and orb3=='dx2y2' and orb4=='d3z2r2' and orb5=='dx2y2':
                    wgt_d7d8L[2]+=abs(vecs[istate,k])**2   
                if orb1=='dx2y2' and orb2=='dx2y2' and orb3=='dx2y2' and orb4=='dx2y2' and orb5=='dx2y2':
                    wgt_d7d8L[3]+=abs(vecs[istate,k])**2                 
                    
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 in pam.Ni_Cu_orbs) and (orb6 in pam.O_orbs) and z1==z2==z6==2 and z3==z4==z5==0 : 
                wgt_d7d8L[1]+=abs(vecs[istate,k])**2        
                if orb1=='d3z2r2' and orb2=='dx2y2' and orb3=='d3z2r2' and orb4=='dx2y2' and orb5=='dx2y2':
                    wgt_d7d8L[4]+=abs(vecs[istate,k])**2   
                if orb1=='dx2y2' and orb2=='dx2y2' and orb3=='dx2y2' and orb4=='dx2y2' and orb5=='dx2y2':
                    wgt_d7d8L[5]+=abs(vecs[istate,k])**2  
                    
                    
                    
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 in pam.Ni_Cu_orbs) and (orb6 in pam.Obilayer_orbs) and z1==z2==z3==2 and z4==z5==0 : 
                wgt_d7d8O[0]+=abs(vecs[istate,k])**2                       
                    
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 in pam.Ni_Cu_orbs) and (orb6 in pam.Obilayer_orbs) and z1==z2==2 and z3==z4==z5==0 : 
                wgt_d7d8O[1]+=abs(vecs[istate,k])**2        
                
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 not in pam.Ni_Cu_orbs) and (orb6 not in pam.Ni_Cu_orbs) and z1==z2==z3==2 and z4==0 : 
                wgt_d7d9[0]+=abs(vecs[istate,k])**2                     
                
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 in pam.Ni_Cu_orbs) and (orb5 not in pam.Ni_Cu_orbs) and (orb6 not in pam.Ni_Cu_orbs) and z1==2 and z2==z3==z4==0 : 
                wgt_d7d9[1]+=abs(vecs[istate,k])**2                  
                                        
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 not in pam.Ni_Cu_orbs) and (orb5 not in pam.Ni_Cu_orbs) and (orb6 not in pam.Ni_Cu_orbs) and z1==z2==z3==2  : 
                wgt_d7d10[0]+=abs(vecs[istate,k])**2     
                
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs) and  (orb3 in pam.Ni_Cu_orbs) and (orb4 not in pam.Ni_Cu_orbs) and (orb5 not in pam.Ni_Cu_orbs) and (orb6 not in pam.Ni_Cu_orbs) and z1==z2==z3==0  : 
                wgt_d7d10[1]+=abs(vecs[istate,k])**2                     
    ...
    print ('d7d7=',wgt_d7d7[0]/number)       
    print ('d7d8L=',wgt_d7d8L[0]/number)       
    print ('d8Ld7=',wgt_d7d8L[1]/number)       
    print ('d7d8O=',wgt_d7d8O[0]/number)       
    print ('d8Od7=',wgt_d7d8O[1]/number)  
    print ('d7d9=',wgt_d7d9[0]/number)     
    print ('d9d7=',wgt_d7d9[1]/number)      
    print ('d7d10=',wgt_d7d10[0]/number)     
    print ('d10d7=',wgt_d7d10[1]/number)     
    ...
    sumweight2 = wgt_d8Ld8L[0]+wgt_d9L2d8L[0]+wgt_d9L2d8L[1]+wgt_d9L2d9L2[0]+wgt_d9L2L3[0]+wgt_d9L2L3[1]+wgt_L3L3[0]+wgt_d8O2d8[0]\
             ...
             +wgt_d8d8L2[0]+wgt_d8d8L2[1]+wgt_d9O2d8L[0]+wgt_d9O2d8L[1]+wgt_d8LOd9L[0]+wgt_d8LOd9L[1]+wgt_d7d7[0]+wgt_d7d8L[0]+wgt_d7d8L[1]\
             +wgt_d7d8O[0]+wgt_d7d8O[1]+wgt_d7d9[0]+wgt_d7d9[1]+wgt_d7d10[0]+wgt_d7d10[1]
    ...
    txt=open('./data/d7d7','a')                                  
    txt.write(str(wgt_d7d7[0]/number)+'\n')
    txt.close()  
    txt=open('./data/d7d7_a1b1b1_a1b1b1','a')                                  
    txt.write(str(wgt_d7d7[1]/number)+'\n')
    txt.close()      
    txt=open('./data/d7d7_a1a1b1_a1a1b1','a')                                  
    txt.write(str(wgt_d7d7[2]/number)+'\n')
    txt.close()          
    txt=open('./data/d7d7_b1b1b1_b1b1b1','a')                                  
    txt.write(str(wgt_d7d7[3]/number)+'\n')
    txt.close()              
    
    txt=open('./data/d7d8L','a')                                  
    txt.write(str(wgt_d7d8L[0]/number+wgt_d7d8L[1]/number)+'\n')
    txt.close()      
    txt=open('./data/d7d8L_a1b1b1_a1b1','a')                                  
    txt.write(str(wgt_d7d8L[2]/number+wgt_d7d8L[4]/number)+'\n')
    txt.close()          
    txt=open('./data/d7d8L_b1b1b1_b1b1','a')                                  
    txt.write(str(wgt_d7d8L[3]/number+wgt_d7d8L[5]/number)+'\n')
    txt.close()          
    txt=open('./data/d7d8O','a')                                  
    txt.write(str(wgt_d7d8O[0]/number+wgt_d7d8O[1]/number)+'\n')
    txt.close()     
    txt=open('./data/d7d9','a')                                  
    txt.write(str(wgt_d7d9[0]/number+wgt_d7d9[1]/number)+'\n')
    txt.close()         
    txt=open('./data/d7d10','a')                                  
    txt.write(str(wgt_d7d10[0]/number+wgt_d7d10[1]/number)+'\n')
    txt.close()        
