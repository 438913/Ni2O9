...
dL_type_list = ('d8L_d8L', 'd7_d8L', 'd8L_d9L2', 'd7_d9L2',
                'd7_d7', 'd8L_O_d9L', 'd8_O_d8L', 'd7L_d8')
...
labels = (r'$d^8L$-$d^8L$', r'$d^7$-$d^8L$', r'$d^8L$-$d^9L^2$', r'$d^7$-$d^9L^2$',
          r'$d^7$-$d^7$', r'$d^8L$-$O$-$d^9L$', r'$d^8$-$O$-$d^8L$', r'$d^7L$-$d^8$')
line_styles = ['g', 'peru', 'cyan', 'k', 'y', 'r', 'm', 'orange']
marker_styles = ['d', '^', 'o', 'p', '>', '|', 'x', '*']
tpds1 = np.arange(0, 1.1, 0.2)
length1 = len(tpds1)
tpds2 = np.arange(1.2, 4.21, 0.2)
for i in range(type_num):
...
ax.axvline(1.1, ymax=0.4, color='k', linewidth=0.8)
