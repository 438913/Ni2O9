...
#     H0 = T_pd   
    ...
    if Norb==5 or Norb==8 or Norb==10 or Norb==11 or Norb==12:     
        Hint_Ni = ham.create_interaction_matrix_ALL_syms(VS,d_Ni_double,double_Ni_part, idx_Ni, hole34_Ni_part,  \
                                                      S_Ni_val, Sz_Ni_val,AorB_Ni_sym, ACu, ANi, 1)
        Hint_Cu = ham.create_interaction_matrix_ALL_syms(VS,d_Cu_double,double_Cu_part, idx_Cu, hole34_Cu_part, \
                                                      S_Cu_val, Sz_Cu_val,AorB_Cu_sym, ACu, ANi, 1)
...
#             H = U_other_d.dot(H.dot(U_other))
        H_coupled = U_coupled_d.dot(H.dot(U_coupled))
        ...
        if pam.if_get_ground_state==1:
            gs.get_ground_state(H, VS, S_Ni_val,Sz_Ni_val,S_Cu_val,Sz_Cu_val,coupled_idx, jm_list, bonding_val)
...
if __name__ == '__main__':
    ...
    for ANi in pam.ANis:
        ...
        #         print(U_Cu)
            ...
            # util.checkU_unitary(U_coupled,U_coupled_d)
