...
#     print (vals)
    ...
    wgt_d7d9 = np.zeros(50)     
    wgt_d7d10L = np.zeros(50)
    wgt_d7Od10 = np.zeros(50)    
            ...
            if (orb1 in pam.Obilayer_orbs):    
                ...
                if bonding==-1:
                    wgt_ddds[48]+=abs(vecs[istate,k])**2                         
                      ...
                      and (orb4 in pam.Ni_Cu_orbs) and ((z1==z2==z3==2 and z4==0) or (z1==2 and z2==z3==z4==0)):
                wgt_d7d9[0]+=abs(vecs[istate,k])**2                           
                        
            elif (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs)  and  (orb3 in pam.Ni_Cu_orbs) \
                      and (orb4 in pam.O_orbs) and ((z1==z2==z3==2 and z4==0) or (z4==2 and z1==z2==z3==0)):
                wgt_d7d10L[0]+=abs(vecs[istate,k])**2  
                
            if (orb1 in pam.Ni_Cu_orbs) and (orb2 in pam.Ni_Cu_orbs)  and  (orb3 in pam.Ni_Cu_orbs) \
                      and (orb4 in pam.Obilayer_orbs) and ((z1==z2==z3==2 ) or ( z1==z2==z3==0)):
                wgt_d7Od10[0]+=abs(vecs[istate,k])**2  
...
#         print ('s00=',s00)          
    ...
    txt.write(str(wgt_d7d9[0]/number)+'\n')
    txt.close()       
    txt=open('./data/d7d10L','a')                                  
    txt.write(str(wgt_d7d10L[0]/number)+'\n')
    txt.close()         
    txt=open('./data/d7Od10','a')                                  
    txt.write(str(wgt_d7Od10[0]/number)+'\n')
    txt.close()         
...
#     print ('d10d9L3=',wgt_d10d9L3[2]/number)
    ...
    print ('d7d10L=',wgt_d7d10L[0]/number) 
    print ('d7Od10=',wgt_d7Od10[0]/number) 
